...
the data must be filter prior running the DA test. The `filterSCE()` 
...
that determines which condition the samples are assigned to.
...
3. Additional notes for the analysis
...
- `NA` values in the results usually mean that there is not enough cells in the
