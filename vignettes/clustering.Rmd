...
in the sample's information. Details about the data prepation function can be
...
within each cell population, i.e. clusters. In this dataset, the comparison is 
straightforward as there are 2 conditions (`3rd_trim` and `1st_trim`). 
However in case multiple comparisons will be made, the data must be filter prior
running the DA test. The `filterSCE()` (from the `CATALYST` package)
