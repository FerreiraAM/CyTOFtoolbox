...
The two models presented below request to create:
...
the comparison of interest, i.e. what are the combination of paramaters in the 
...
least the minimum of cells ($n = 3$) in at least a minimum of samples ($number of sample / 2$). Some samples might not have any cells (or a low number of cells) in this cluster.
