...
The marker information consists on: channel, antigen and class of the marker.
The marker class is either *type*, *state* or *none*: 

- *type* markers are gating/phenotype markers. They are commonly uses to perfors 
Differential Abundance (DA) tests;
- *state* markers are functional markers. They are commonly uses to perfors 
Differential State (DS) tests;
- *none* markers won't be uses for testing, e.g. event length.
